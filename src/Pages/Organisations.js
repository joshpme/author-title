...
function Organisations() {
    ...
    return (
        <div className={"xl:my-10"}>
            <form onSubmit={(e) => {
                e.preventDefault();
                dispatch(changePage('affiliations'))
            }}>
                <div className={"container mx-auto my-3.5 px-3"}>
                    <h2 className={"text-2xl font-medium"}>Step 4: Organisations</h2>
                    <div className={"my-4"}>

                    </div>

                    <div className={"flex gap-2"}>
                        <button type={"button"} className={"default"} onClick={(e) => dispatch(changePage('authors'))}>
